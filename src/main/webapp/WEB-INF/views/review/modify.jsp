			...
			<div class="container">
				<div class="col-md-12">
					<div class="row contentTitle pb-3 mb-5" style="border-bottom: 1px solid #999;">
						<div class="col-md-12">
							<div class="row mb-2">리뷰 수정 </div>
						</div>
					</div>
					<form action="/review/modify" method="post" name="frm" onsubmit="return clickSubmit()">
						<input type="hidden" name="rno" id="rno" value="${review.rno }">
						<div class="row mb-3">
							<div class="col-md-3">
						...
						<div class="row mb-3">
							...
							<div class="col-md-9">
								<input type="text" name="writer" id="writer" class="form-control" value="${review.writer }" readOnly>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-md-3">
							...
							<div class="col-md-9">
								<input type="text" name="camping" id="camping" class="form-control" value="${review.camping }">
							</div>
						</div>
						...
						<div class="row mb-3">
							<div class="col-md-12">
								<button class="btn btn-primary" type="submit" style="float: right;" >리뷰 수정하기</button>
							</div>
						</div>
					</form> 
				</div>
