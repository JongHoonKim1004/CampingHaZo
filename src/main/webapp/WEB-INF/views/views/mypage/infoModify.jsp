						...
						<div class="col-md-8 bg-white p-3">
							<form class='form p-5' name="frm">
								...
								<div class="row form-group pb-3">
									...
									<div class="col-md-10">
										<input type="text" class='form-control' name="phone" id="phone" placeholder="'-' 를 제외하고 기입해주세요" value="${phone }">
									</div>
								</div>
								<div class="row form-group pb-3">
									<div class="col-md-2">
								...
								<div class="row form-group pb-3">
									...
									<div class="col-md-10">
										<input type="text" class="form-control" name="addr" id="addr" value="${addr }" readOnly>
									</div>
								</div>
								<div class="row form-group pb-3">
									<div class='col-md-2'>
									...
									<div class="col-md-10">
										<input type="text" class="form-control" name="addrDetail" id="addrDetail" value="${addrDetail }">
									</div>
								</div>
