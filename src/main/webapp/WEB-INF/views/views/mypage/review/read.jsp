									...
									<div class="row form-group pb-3">
										<div class="col-md-6">
											<div class="row">
												...
												<div class="col-md-8">
													<input type="text" class="form-control" name="writer" id="writer" value="${writer }" readOnly>
												</div>
											</div>
										</div>
										<div class="col-md-6">
									...
									<div class="row form-group pb-3">
										<div class="col-md-6">
											<div class="row">
												...
												<div class="col-md-8">
													<input type="text" class="form-control" name="readCount" id="readCount" value="${readCount }" readOnly>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row">
												...
												<div class="col-md-8">
													<input type="text" class="form-control" name="updateDate" id="updateDate" value="${updateDate }" readOnly>
												</div>
											</div>
										</div>
									</div>
