...
<head>
    ...
    <link rel="stylesheet" href="/resources/public/demo/chartist-plugin-tooltip.css">
    ...
    <nav class="navbar flex-nowrap p-0">
        <div class="navbar-brand-wrapper d-flex align-items-center col-auto">
            ...
            <a class="navbar-brand navbar-brand-mobile" href="/">
                <img class="img-fluid w-100" src="/resources/img/header/5g_logo1.png" alt="Graindashboard">
            </a>
            <!-- End Logo For Mobile View -->

            <!-- Logo For Desktop View -->
            <a class="navbar-brand navbar-brand-desktop" href="/">
                <img class="side-nav-show-on-closed" src="/resources/img/header/5g_logo1.png" alt="Graindashboard" style="width: auto; height: 33px;">
                <img class="side-nav-hide-on-closed" src="/resources/img/header/5g_logo1.png" alt="Graindashboard" style="width: auto; height: 33px;">
            </a>
