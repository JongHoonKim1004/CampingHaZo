									...
									<div class="row">
										...
										<div class="col-md-7" style="text-align: right;">
											<span>내가 등록한 캠핑장</span><br> <span id="mycampingNumber"
												class="spanNumber">${campingList.size() }</span><span> 개</span>
									...
									<div class="row">
										...
										<div class="col-md-7" style="text-align: right;">
											<span>현재 등록된 예약은</span><br> <span class="spanNumber"
												id="reservationNumber">${reservationList.size() }</span><span> 개</span>
										</div>
									</div>
								</div>
							</div>
									...
									<div class="row">
										...
										<div class="col-md-7" style="text-align: right">
											<span>캠핑장에 달린 리뷰는</span><br> <span
												class="spanNumber" id="reviewNumber">1226</span><span>
												개</span>
										</div>
									</div>
								</div>
											...
											<tr>
												...
												<td>
													<button class="btn btn-primary btn-sm"
														onclick="location.href='/member/reservation/read?rno=${reservation.rno}'">자세히
														보기</button>
												</td>
											</tr>
										</c:forEach>
									...
									<tbody>
										<c:forEach items="${campingList }" var="camp">
											<tr>
												...
												<td>${camp.phone }</td>
												<td>
													<button class="btn btn-primary btn-sm" onclick="location.href='/member/mycamping/read?cno=${camp.cno}'">자세히 보기</button>
												</td>
											</tr>
										</c:forEach>
									</tbody>
